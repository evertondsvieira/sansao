 ...
 */
export type HandlerFunction<TContract extends ContractDefinition> = (ctx: Context<TContract>) => Promise<Response> | Response;
/**
 ...
 */
export declare function defineHandler<TContract extends ContractDefinition>(contract: TContract, handler: HandlerFunction<TContract>): Handler<TContract>;
